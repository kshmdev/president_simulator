    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden" style={{ background: 'var(--gradient-hero)' }}>
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="headline-display text-4xl text-gradient-gold mb-2">
            PRESIDENTIAL
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-muted/50 border border-border rounded-lg text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                required
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-presidential px-8 py-4 rounded-lg text-lg uppercase tracking-wider disabled:opacity-50"
            >
        ...
        <div className="mt-6 text-center">
          <button
            onClick={() => navigate('/')}
            className="text-muted-foreground/50 hover:text-muted-foreground transition-colors text-sm"
          >
            ← Back to game
          </button>
        </div>
